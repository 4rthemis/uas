...
export const SkillCard: React.FC<SkillCardProps> = ({ skill, className }) => {
  return (
    <Card className={`flex flex-col w-full h-[220px] sm:h-[240px] md:h-[260px] bg-[#fff7ea] rounded-xl shadow-[5px_4px_100px_#feb4331a] border-none hover:shadow-[5px_4px_120px_#feb43330] transition-shadow duration-300 ${className}`}>
