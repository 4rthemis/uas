      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Passionate UI/UX Designer with expertise in creating visually appealing and 
            user-friendly digital experiences. I transform ideas into seamless interfaces 
            that users love.
          </p>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-6 rounded-2xl">
            <div className="flex flex-wrap justify-center items-center gap-8 px-6">
              {['UI/UX Designer', 'Product Designer', 'Interaction Designer', 'Design Enthusiast'].map((role, index) => (
                <div key={index} className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                  <span className="text-lg font-medium whitespace-nowrap">{role}</span>
                </div>
              ))}
            </div>
          </div>
